...
from ..schemas.viajero_viaje import ViajeroCreate, ViajeroResponse, ViajeViajeroResponse, ViajeroUpdate
...
@router.get("/{viajero_id}/viajes", response_model=ViajeViajeroResponse)
